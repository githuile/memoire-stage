...
\node[boxmed, below=1.2cm of president] (lamy) {Damien Lamy\\Chef de projet};
\node[boxmed, right=1.8cm of lamy] (andrieu) {Adrien Andrieu\\Chef de projet};

% --- Ligne 3 : Développeurs ---
\node[boxlight, below=1.2cm of lamy] (lerch) {Benjamin Lerch\\Développeur ingénieur};
\node[boxlight, right=1.8cm of lerch] (asaro) {Anthony Asaro\\Développeur technicien};
...
\node[boxlight, right=1.8cm of sechi] (kilian) {Verger Kilian\\Stagiaire};
\node[boxgreen, right=1.8cm of kilian] (miquel) {Vianney Miquel\\Stagiaire};

% --- Groupes par ligne (rectangle englobant) ---
\node[draw=black, rounded corners=6pt, inner sep=8pt, fit=(president) (admin), label=above:{Président + Responsable administrative}] (grp1) {};
...
\draw[line] (grp1.south) -- ++(0,-0.5) -- (grp2.north);
\draw[line] (grp2.south) -- ++(0,-0.5) -- (grp3.north);
\draw[line] (grp3.south) -- ++(0,-0.5) -- (grp4.north);
...
\node[boxdark, above=3.6cm of asaro] (president) {Luc Desruelle\\Président};

\node[boxdark, above=5.2cm of andrieu] (admin) {Emilie Evrard\\Responsable administrative};
